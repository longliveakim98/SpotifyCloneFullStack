...
<!-- create .env file under src = to store secret key and api key -->

<!-- start coding on server.js -->

<!--mongodb connection -->
<!-- driver -> mongoose , copy/paste the api key in .env -->

<!--cloudinary - copy paste the api_name, api_key, api_secret_key to env -->

<!-- create the configs under config folder of both mongodb and cloudinary then import the functions to server.js -->
